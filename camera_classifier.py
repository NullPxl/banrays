...
WIDTH_MAX_MS = 120.0  # maximum FWHM width (camera spikes are narrow)
RISE_MIN     = 0.175    # minimum rise slope (diff units per ms)
FALL_MIN     = 0.175   # minimum fall slope magnitude
